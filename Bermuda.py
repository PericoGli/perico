# This source has been made and developed by Boom and Bermuda.
...
async def changelog(ctx):
    ...
    changelog.add_field(name="Credits", value="▸ Boom & Bermuda <3", inline=False)
...
async def stats(ctx):
	...
	embed.set_footer(text="Discord Bot Developed By Boom and Bermuda <3")
